...
--------------------------
• Used by:
    - src_Connection.Centralized: set_seed, pick_device, log, torch_loader_kwargs
    - src_Connection.Client: set_seed, sanitize_mps_env, pick_device, ensure_dir, torch_loader_kwargs
    - src_Connection.Server: ensure_dir (CSV/viz output)
    - src_Connection.Experiments: set_seed, log, ensure_dir, torch_loader_kwargs
    - src_Connection.tuning: ensure_dir, set_seed
    - src_Connection.results_visualization: ensure_dir (viz folder creation)
